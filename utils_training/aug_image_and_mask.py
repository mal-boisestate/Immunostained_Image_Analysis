...
if __name__ == '__main__':
    img_folder_path = r"D:\BioLab\img\training_sets\nucleus_training_mathlab_alternative\Anamaria training set\img"
    mask_folder_path =r"D:\BioLab\img\training_sets\nucleus_training_mathlab_alternative\Anamaria training set\mask"

    for i, img_path in enumerate(glob.glob(os.path.join(img_folder_path, "*.png"))):
        ...
        for j in np.arange(4):
            ...
            img_path_to_save = os.path.join(r"D:\BioLab\img\training_sets\nucleus_training_mathlab_alternative\Anamaria training set\img_aug", img_file_name)
            mask_path_to_save = os.path.join(r"D:\BioLab\img\training_sets\nucleus_training_mathlab_alternative\Anamaria training set\mask_aug", mask_file_name)
